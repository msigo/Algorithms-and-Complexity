...
public class Main_alternative {
  ...
  public static List<String> readWordList(BufferedReader input) throws IOException {
    ...
    input = new BufferedReader(new InputStreamReader(new FileInputStream(System.getProperty("user.dir")+"/src/testfall/testmedordlista.indata.txt"),"UTF-8"));
    while (true) {
